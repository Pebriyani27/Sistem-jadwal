...
<head>
    ...
    <style>
    body {
        background:rgb(197, 155, 167); /* Soft pink background */
    ...
    .sidebar-custom {
        ...
        color: #fff;
        min-height: 100vh;
        box-shadow: 2px 0 8px rgba(243, 239, 239, 0.05);
    ...
    .sidebar-custom .nav-link:hover {
        background: #fff;
        color:rgb(158, 95, 126); /* Pink utama */
    }
    .sidebar-custom h4 {
        font-weight: bold;
        letter-spacing: 1px;
    ...
    .main-header {
        background: rgba(238, 77, 123, 0.85); /* transparan pink */
        border-radius: 16px;
        box-shadow: 0 2px 16px rgba(236, 72, 153, 0.08); /* bayangan pink */
    ...
    .card-custom {
        border-radius: 20px;
        box-shadow: 0 4px 24px rgba(241, 238, 240, 0.1);
        border: none;
        margin-bottom: 24px;
